            ...
            <div class="container">
                <div class="navbar-header">
                    ...
                    <c:choose>
                        <c:when test="${menutype == 'thesis_menu'}">
                            <a class="navbar-brand" href="/student/thesis_homepage.html">Thesis App</a>
                        </c:when>
                        <c:otherwise>
                ...
                <div id="navbar" class="navbar-collapse collapse">
                    <ul class="nav navbar-nav">
                        <c:choose>
                            <c:when test="${menutype == 'thesis_menu'}">
                                <li class="${currentPage == 'comments' ? 'active' : ''}"><a href="/student/comments.html"><spring:message code="messages.student.menu.thesis.comments" text=""/></a></li>
                            </c:when>
                            <c:otherwise>
