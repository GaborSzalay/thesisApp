...
public class UrlProvider {
    ...
    public static final String CREATE_COURSE_URL = "/admin/course.html";
    ...
    public static final String LIST_TEACHERS_URL = "/admin/list_teachers.html";
    ...
    public static final String TEACHER_COMMENTS_URL = "/teacher/comments.html";
    public static final String STUDENT_THESIS_CREATE_COMMENT_URL = "/student_thesis/create_comment.html";
    public static final String TEACHER_THESIS_CREATE_COMMENT_URL = "/teacher/create_comment.html";
